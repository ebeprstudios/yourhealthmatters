...
const ORGANS = [
  { organ: 'Brain', color: '#7c6aff', icon: '🧠', action: 'Glymphatic cleaning flushes beta-amyloid + tau proteins. The brain\'s ONLY cleaning mechanism, and it only works during sleep.', timing: 'All night, peaks hrs 3–6' },
