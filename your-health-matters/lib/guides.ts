// lib/guides.ts — Complete guide data for all 11 healing documents
...
export const guides: Guide[] = [
  {
    ...
    chatScope: 'You are Dr. Vera answering questions about this Holistic Health Cheat Sheet. Focus on cholesterol management (LDL/HDL), blood glucose stabilization, kidney health, the daily protocol, supplement timing (Chromium Picolinate 400mcg), and the three-goal framework.',
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'Avoid Zone (9pm-sleep): No juice. Water only.',
        ]
      },
      {
    ...
    chatScope: 'You are Dr. Vera answering questions about insulin sensitivity, the 24-hour insulin activity curve, the four time zones (Peak 6am-2pm, Declining 2-6pm, Caution 6-9pm, Avoid 9pm+), when to eat fruit and juice, and how meal timing affects LDL, HDL, triglycerides, and blood glucose.',
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          'This guide organizes all vegetables by their primary organ system target. The 18 systems covered: Heart, Kidneys, Blood Glucose, Liver, Anti-Inflammatory, Gut, Artery Health, Cellular Health, Brain, Skin, Lymphatic, Adrenal, Blood Health, Eyes, Thyroid, Immune, Bones and Joints, and Lungs.',
          'Many vegetables span multiple systems. Spinach appears in 13 of the 18 systems - making it the most cross-system healing vegetable catalogued.',
        ]
      },
      {
    ...
    chatScope: 'You are Dr. Vera answering questions about healing vegetables, the 18 organ systems, which vegetables serve which body systems, raw vs cooked distinctions, and specific vegetables for cholesterol, glucose, kidney, liver, inflammation, gut, and brain health.',
  },
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'Kiwi: spans 13 organ systems. Actinidin - most studied natural compound for gastric emptying. Vitamin C and K combination supports both immune and arterial health simultaneously.',
          'Elderberry: the only fruit compound proven to physically block viral entry into cells. Used in European herbal medicine for respiratory infections for centuries.',
          'Blueberries: pterostilbene activates sirtuins - longevity proteins that govern cellular aging. Anthocyanins cross the blood-brain barrier and stimulate BDNF within 12 weeks of daily consumption.',
        ]
      },
    ],
    chatScope: 'You are Dr. Vera answering questions about healing fruits, which fruits serve which organ systems, when to eat fruit based on insulin timing, pomegranate for artery health, kiwi for digestion, blueberries for brain, elderberry for immune defense, and global healing fruits like baobab and amla.',
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          'Cholesterol: Berberine (500mg 2-3x/day with meals) - inhibits PCSK9 and activates AMPK simultaneously. Artichoke leaf extract stimulates bile acid production for active LDL clearance.',
          ...
          'Kidneys: Dandelion root - potassium-sparing diuretic. Chanca piedra - phyllanthin inhibits calcium oxalate crystal formation. Marshmallow root cold infusion - mucilage soothes inflamed urinary tissue.',
        ]
      },
      {
    ...
    chatScope: "You are Dr. Vera answering questions about medicinal herbs, their dosages and preparations, which herbs serve which organ systems, Ayurvedic herbs, TCM herbs, West African and Amazon herbs, berberine vs metformin, milk thistle for liver, herb-drug interactions, and how to build a complete herbal protocol.",
  },

  {
    ...
    chatScope: 'You are Dr. Vera answering questions about therapeutic juicing, the 64 juice recipes, the insulin time zones for juice consumption, the 8 preparation rules, specific juice recipes for cholesterol, glucose, kidney, liver, brain, and immune health.',
  },

  {
    ...
    chatScope: 'You are Dr. Vera answering questions about healing salads, the salad formula, the 47 salad recipes by organ system, why to eat salad first at every meal, dressing rules (EVOO always, lemon/ACV always, turmeric with black pepper), and how to build a salad for specific conditions.',
  },

  {
    ...
    chatScope: 'You are Dr. Vera answering questions about the overnight repair cycle (7pm-6am), growth hormone secretion, autophagy and when it activates, glymphatic brain flushing, liver Phase II detox (1-3am peak), what to eat in each phase, why the kitchen closes at 7pm, and the morning rising protocol.',
  },

  {
    ...
    chatScope: "You are Dr. Vera answering questions about daytime hormone activity, the morning activation phase, peak metabolic window, midday maintenance, afternoon wind-down, best times to exercise, eat, juice, and supplement, the 3pm energy dip, and how to structure a healing day from 6am to 7pm.",
  },
